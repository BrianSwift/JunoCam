...
bpy.ops.import_scene.obj(filepath="/Users/bswift/Downloads/PJ0EFB/P00_102.obj",axis_forward='Y', axis_up='Z')
# Replace materials created by blender obj import with JunoTemplateMaterial from JunocamLibrary.blend
holdMatName=bpy.data.objects['P00_102r'].data.materials[0].name
holdImage=bpy.data.objects['P00_102r'].data.materials[0].node_tree.nodes['Image Texture'].image
bpy.data.objects['P00_102r'].data.materials[0].name='avoidCollision'
bpy.data.objects['P00_102r'].data.materials[0]=bpy.data.materials['JunoTemplateMaterial'].copy()
bpy.data.objects['P00_102r'].data.materials[0].name=holdMatName
bpy.data.objects['P00_102r'].data.materials[0].node_tree.nodes['Image Texture'].image=holdImage
# configure objects layers to match render layer for that objects color
bpy.data.objects['P00_102r'].layers=bpy.data.scenes['JunoScene'].render.layers["rl.r"].layers

holdMatName=bpy.data.objects['P00_102g'].data.materials[0].name
holdImage=bpy.data.objects['P00_102g'].data.materials[0].node_tree.nodes['Image Texture'].image
bpy.data.objects['P00_102g'].data.materials[0].name='avoidCollision'
bpy.data.objects['P00_102g'].data.materials[0]=bpy.data.materials['JunoTemplateMaterial'].copy()
bpy.data.objects['P00_102g'].data.materials[0].name=holdMatName
bpy.data.objects['P00_102g'].data.materials[0].node_tree.nodes['Image Texture'].image=holdImage
# configure objects layers to match render layer for that objects color
bpy.data.objects['P00_102g'].layers=bpy.data.scenes['JunoScene'].render.layers["rl.g"].layers

holdMatName=bpy.data.objects['P00_102b'].data.materials[0].name
holdImage=bpy.data.objects['P00_102b'].data.materials[0].node_tree.nodes['Image Texture'].image
bpy.data.objects['P00_102b'].data.materials[0].name='avoidCollision'
bpy.data.objects['P00_102b'].data.materials[0]=bpy.data.materials['JunoTemplateMaterial'].copy()
bpy.data.objects['P00_102b'].data.materials[0].name=holdMatName
bpy.data.objects['P00_102b'].data.materials[0].node_tree.nodes['Image Texture'].image=holdImage
# configure objects layers to match render layer for that objects color
bpy.data.objects['P00_102b'].layers=bpy.data.scenes['JunoScene'].render.layers["rl.b"].layers

# Add image specific camera
newCamera=bpy.data.objects['Camera'].copy()
newCamera.name='CP00_102_01'
...
bpy.context.scene.camera=bpy.data.objects['CP00_102_82']
bpy.context.scene.objects.active=bpy.data.objects['CP00_102_82']
# Above camera selection manually changed to 82 because "middle" frames aren't pointed towards earth
